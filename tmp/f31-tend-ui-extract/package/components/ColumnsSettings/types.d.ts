...
import { DrawerProps as _DrawerProps } from '@10d/tend-ui-primitives';
 ...
 */
export interface CoreColumnsSettingsProps<T extends ColumnConfig = ColumnConfig> extends ColumnsSettingsPresets {
    columns: T[];
...
export type ColumnsSettingsProps<T extends ColumnConfig = ColumnConfig> = CoreColumnsSettingsProps<T> & {
    /**
     * Заголовок
     */
