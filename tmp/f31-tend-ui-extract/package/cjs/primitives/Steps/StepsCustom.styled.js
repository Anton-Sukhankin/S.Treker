  ...
  ${props => {
    ...
    const hoverStyles = `
      &:hover {
        ...
        .tend-ui-steps-item-icon [data-status=${types.ProcessStepTypes.FUTURE}] {
          border: 1.5px solid ${global.colors.gray400};
        }
        ...
        &:has(> .tend-ui-steps-item-container > .tend-ui-steps-item-icon [data-status=${types.ProcessStepTypes.ACTIVE}]) {
        ...
        &:has(> .tend-ui-steps-item-container > .tend-ui-steps-item-icon [data-status=${types.ProcessStepTypes.DISABLED}]) {
          .tend-ui-steps-item-content {
            .tend-ui-steps-item-description * {
      ...
      &.tend-ui-steps {
        &.tend-ui-steps-label-horizontal {
          .tend-ui-steps-item {
            ...
            &:has(> .tend-ui-steps-item-container > .tend-ui-steps-item-icon [data-status=${types.ProcessStepTypes.FINISH}]),
            &:has(> .tend-ui-steps-item-container > .tend-ui-steps-item-icon [data-status=${types.ProcessStepTypes.ACTIVE}]) {
              .tend-ui-steps-item-content .tend-ui-steps-item-title * {
                color: ${props.$theme.colors.gray900};
              }
