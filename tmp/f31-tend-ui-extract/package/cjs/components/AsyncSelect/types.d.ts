...
import { DefaultOptionType, SelectProps as DefaultSelectProps } from '../../primitives/Select';
...
export type AsyncSelectProps<D extends object = object> = Omit<DefaultSelectProps<D>, 'options' | 'notFoundContent' | 'loading'> & BaseAsyncSelectProps<D>;
export type AsyncSelectComponent = (<D extends object = object>(props: AsyncSelectProps<D> & {
