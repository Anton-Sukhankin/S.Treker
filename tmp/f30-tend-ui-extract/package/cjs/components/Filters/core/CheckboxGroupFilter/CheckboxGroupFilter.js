...
const CheckboxGroupFilter = (props) => {
    ...
    return (React__default["default"].createElement(Checkbox.Checkbox.Group, Object.assign({ layout: 'vertical', disabled: disabled }, omit__default["default"](props, 'config'))));
};

exports.CheckboxGroupFilter = CheckboxGroupFilter;
