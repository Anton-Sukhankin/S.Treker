...
const BaseAsyncRadio = (_a, ref) => {
    ...
    return (React__default["default"].createElement(RadioGroupSearch.RadioGroupSearch, Object.assign({}, props, { error: Boolean(error), loading: loading, options: options, onSearch: handleSearch, filterOption: filterOption, onScroll: handleScroll })));
};
const AsyncRadio = React__default["default"].forwardRef(BaseAsyncRadio);
AsyncRadio.displayName = 'AsyncRadio';

exports.AsyncRadio = AsyncRadio;
