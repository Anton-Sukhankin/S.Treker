...
import type { FormProps as AntFormProps, FormInstance, Rule, RuleObject, RuleRender } from 'antd-core/es/form';
type BaseFormProps = {
    gap?: number;
};
...
export type { FormComponent, FormProps, FormRef, FormInstance, FormRuleObject, FormValidator, FormRule, FormRuleRender, };
