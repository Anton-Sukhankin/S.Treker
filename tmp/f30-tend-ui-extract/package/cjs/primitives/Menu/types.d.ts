...
import { MenuDividerType as AntMenuDividerType, MenuItemGroupType as AntMenuItemGroupType, MenuItemType as AntMenuItemType, SubMenuType as AntSubMenuType } from 'antd-core/es/menu/hooks/useItems';
...
export interface SubMenuType<T extends MenuType = MenuType> extends Pick<AntSubMenuType<T>, 'key' | 'label' | 'children' | 'disabled'> {
    badge?: Counter | Dot;
}
export type MenuGroupType<T extends MenuType = MenuType> = Pick<AntMenuItemGroupType<T>, 'key' | 'label' | 'children' | 'type'>;
export type MenuItemType<T extends MenuType = MenuType> = T | SubMenuType<T> | MenuGroupType<T> | MenuDividerType | null;
