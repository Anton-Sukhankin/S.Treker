...
import { ColumnConfig, FilterConfig, SorterConfig, SortingOrder, TableForm } from '../../../../features/Table/types';
import { FormInstance } from '../../../../components/Form';
import { ColumnPosition } from '../../../../components/ColumnsSettings/types';
import { GenericObject } from '../../../../types/GenericObject';
export type RootProps<TFilter extends GenericObject = GenericObject, TColumn extends ColumnConfig = ColumnConfig> = {
     ...
     */
    onSorterValuesChange?: (changed: Partial<Record<keyof TFilter, SortingOrder>>, values: Record<keyof TFilter, SortingOrder>) => void;
    /**
     *
