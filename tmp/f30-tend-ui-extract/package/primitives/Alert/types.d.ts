...
export declare const types: readonly ["success", "error", "warning", "info", "neutral", "loading"];
export type AlertType = (typeof types)[number];
type BaseAlertProps = {
    /**
     * Обводка
     * @deprecated `Alert` с обводкой начиная с версии `4.11.0` удален из дизайн системы. За более подробной информацией обратись в чат `S.TendUI Support`
     */
    border?: boolean;
    /**
     * Можно ли скрыть
...
export type AlertProps = Omit<React.HTMLAttributes<HTMLDivElement>, 'children'> & BaseAlertProps & MarginProperties;
export {};
