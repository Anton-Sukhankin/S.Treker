...
import { RadioGroupProps, RadioOptionType } from '../../primitives/Radio';
...
type BaseRadioGroupSearch = {
     ...
     */
    optionAfter?: React.ReactNode | ((option: RadioGroupSearchOptionType) => React.ReactNode);
    /**
     * Контент под опцией
     */
...
export type RadioGroupSearchProps = Omit<RadioGroupProps, 'options'> & BaseRadioGroupSearch;
export {};
