...
const RadioGroupSearchFilter = (props) => {
    ...
    return (React__default["default"].createElement(RadioGroupSearch.RadioGroupSearch, Object.assign({ layout: 'vertical', disabled: disabled }, omit__default["default"](props, 'config'))));
};

exports.RadioGroupSearchFilter = RadioGroupSearchFilter;
