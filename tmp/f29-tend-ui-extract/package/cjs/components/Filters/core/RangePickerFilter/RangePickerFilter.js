...
const RangePickerFilter = (props) => {
    ...
    return React__default["default"].createElement(RangePicker.RangePicker, Object.assign({ fullWidth: true, disabled: disabled }, omit__default["default"](props, 'config')));
};

exports.RangePickerFilter = RangePickerFilter;
