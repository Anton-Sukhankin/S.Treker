...
var AntPagination = require('antd-core/es/pagination');
var styled = require('styled-components');

function _interopDefault (e) { return e && e.__esModule ? e : { default: e }; }

var AntPagination__default = /*#__PURE__*/_interopDefault(AntPagination);
var styled__default = /*#__PURE__*/_interopDefault(styled);

const PaginationButton = styled__default["default"].span.attrs({
    $variant: {
        medium: '32px',
        small: '24px',
    },
...
`;
const Root = styled__default["default"](AntPagination__default["default"]) `
  &.tend-ui-pagination {
    display: flex;

    .tend-ui-pagination-total-text {
      display: flex;
      align-items: center;
    ...
    .tend-ui-pagination-options-quick-jumper {
      margin-right: auto;
    }

    .tend-ui-pagination-options-size-changer {
      display: inline-flex;
      align-items: center;
    ...
    .tend-ui-select.tend-ui-select-open .tend-ui-select-selector::after {
    ...
    styled.css `
        .tend-ui-pagination-item,
        .tend-ui-pagination-prev,
        .tend-ui-pagination-next,
        .tend-ui-pagination-jump-next,
        .tend-ui-pagination-jump-prev,
        .tend-ui-pagination-options-quick-jumper {
