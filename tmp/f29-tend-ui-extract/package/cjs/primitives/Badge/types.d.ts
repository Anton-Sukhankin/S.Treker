...
export declare const presets: readonly ["default", "success", "warning", "processing", "error", "gray", "blue", "geekblue", "green", "yellow", "red", "cyan", "volcano", "purple", "gray-light", "blue-light", "geekblue-light", "green-light", "yellow-light", "red-light", "cyan-light", "volcano-light", "purple-light"];
export declare const variants: readonly ["dot", "counter", "bubble", "status"];
